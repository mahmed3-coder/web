  ...
  <body>
    ...
    <table>
      <tr>
        ...
        <form method="post" action="mainForPlaytimePad.php">
        <label for="PlaytimePadId">PlaytimePadID:</label>
      <input type="text" name="PlaytimePadId" id="PlaytimePadId" required>
      <br>
    ...
    <br>
      <input type="submit" value="Add Playtimepad">
    </form>
      </tr>
      <?php include 'mainForPlaytimePad.php'; ?>
      <?php
        $query = "SELECT * FROM PlaytimePad";
