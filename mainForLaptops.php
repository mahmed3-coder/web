        ...
        <?php
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
						...
						echo "<td>";
						echo "<form method='post' action='deletelaptop.php'>";
						echo "<input type='hidden' id='LaptopId' name='LaptopId' value='" . $row['LaptopId'] . "'>";
				...
				if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				  ...
				  $sql = "INSERT INTO Laptop (LaptopId, Brand_OS, Model, SerialNumber, Usable, Passwd, AbleToConnectToWifi, CapacityToRunZoom, AbleToBeCharged, FactoryReseted, SpeakerAndMicFunctionality,
				   SystemUpdated, Notes, DateChecked ) 
						  VALUES ('$IdLaptop','$brand_os', '$model', '$serial_number', '$usable', '$passwd', '$abletoconnectwifi', '$runZoom', '$abletocharge','$factoryreset', '$SpeakerAndMicFunctionality',
