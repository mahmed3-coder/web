  ...
  <body>
    ...
    <table>
      <tr>
        ...
        <form method="post" action="mainForIpadAir.php">
        <label for="">iPadAirId:</label>
      <input type="text" name="iPadAirId" id="iPadAirId" required>
      <br>
    ...
    <br>
      <input type="submit" value="Add iPadAir">
    </form>
      </tr>
      <?php include 'mainForIpadAir.php'; ?>
      <?php
        $query = "SELECT * FROM Ipadair";
