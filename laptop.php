  ...
  <body>
    ...
    <table>
      <tr>
        ...
        <form method="post" action="mainForLaptops.php">
        <label for="LaptopId">LaptopId:</label>
      <input type="text" name="LaptopId" id="LaptopId" required>
      <br>
    ...
    <br>
      ...
      <?php include 'mainForLaptops.php'; ?>
      <?php
