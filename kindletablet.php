  ...
  <body>
    ...
    <table>
      <tr>
        ...
        <form method="post" action="mainForkindletablet.php">
        <label for="KindleId">KindleId:</label>
      <input type="text" name="KindleId" id="KindleId" required>
      <br>
    ...
    <br>
      <input type="submit" value="Add Kindle">
    </form>
      </tr>
      <?php include 'mainForkindletablet.php'; ?>
      <?php
        $query = "SELECT * FROM KindleTablet";
